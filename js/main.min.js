...
/* harmony import */ var _modules_init_toggle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-toggle */ "./js/modules/init-toggle.js");
...
Object(_modules_init_toggle__WEBPACK_IMPORTED_MODULE_4__["initToggle"])();
...
var modalCallbackBtns = document.querySelectorAll('[data-modal="callback"]');
...
var initModals = function initModals() {
  ...
  if (modalCallback && modalCallbackBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalCallback, false, modalCallbackBtns, true, false);
  }
};
...
var sliderBlock = document.querySelector('[data-slider]');
...
var toggleMenuBtn = document.querySelector('[data-toggle-menu]');
var navMenu = document.querySelector('[data-menu]');
var toggleProductsMenuBtn = document.querySelector('[data-toggle-products-menu]');
var productsMenu = document.querySelector('[data-products-menu]');
var overlay = document.querySelector('[data-overlay]');

var onClickToggle = function onClickToggle(btn) {
...
var initToggle = function initToggle() {
  ...
  toggleProductsMenuBtn.addEventListener('click', function () {
